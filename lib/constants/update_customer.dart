...
const String kKeyUserRole = "customer";
const String kKeyUsername = "username";
const String kKeyMessageImage = "image";
const String kKeyMessageName = "name";
const String kKeyMessageId = "id";
const String kKeyMainMessageId = "main_id";
...
const String kKeyResiverID = 'resiverId';
